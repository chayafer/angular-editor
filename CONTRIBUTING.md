...
it hasn't already been reported. You can [search through existing @chayafer/angular-editor issues](https://github.com/kolkov/angular-editor/issues)
...
[StackOverflow](http://stackoverflow.com/questions/ask?tags=angular,@chayafer/angular-editor) before reporting it. This
...
* [AngularEditor](https://github.com/kolkov/angular-editor) (`@chayafer/angular-editor` on npm)
...
After executing these steps, your local copy of `@chayafer/angular-editor-app` will be built using your local copy of `@chayafer/angular-editor`
instead of the prebuilt version specified in `package.json`.

## Develop

* `npm run build and watch angular-editor`: Continuously builds the `@chayafer/angular-editor` code when sources change.
